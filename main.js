...
/* harmony import */ var date_fns_differenceInHours__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns/differenceInHours */ "./node_modules/date-fns/esm/differenceInHours/index.js");
...
let dom = (function () {
  ...
  function showMinimumtoDo(obj, todoindex, projectindex,reference) {
    ...
    dueDate.innerText = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(obj.dueDate, "Pp");
...
function showtodaytodos() {
  ...
  for (let i = 0; i < projects.getList.length; i++) {
    ...
    for (let j = 0; j < project.getList.length; j++) {
      ...
      if (
        (0,date_fns_differenceInHours__WEBPACK_IMPORTED_MODULE_1__["default"])(
          dateDue,
